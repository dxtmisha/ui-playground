...
var k = (s, t, e) => t in s ? y(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e;
var a = (s, t, e) => (k(s, typeof t != "symbol" ? t + "" : t, e), e);
import { computed as d, shallowRef as f, watchEffect as m, onUnmounted as I, watch as S, h as z } from "vue";
import { g as p, b as l, k as C, i as x, D as H } from "./DesignConstructorAbstract-BkPabKy_.js";
import { D as w } from "./DesignAsyncAbstract-DNnh9quE.js";
import { C as j } from "./CacheItem-J86vAm6_.js";
import { u as W } from "./useEnv-DZ3hLZim.js";
import { t as v } from "./number-Bmx0fGP3.js";
import { b as A } from "./element-COvSoy4d.js";
import { E as B } from "./EventItem-C7DLzmH2.js";
class g {
  /**
  ...
  static get(t, e = "") {
    var i, r;
    return ((i = this.icons) == null ? void 0 : i[this.getName(t)]) ?? ((r = this.icons) == null ? void 0 : r[t]) ?? `${t.replace(/^@/, e ?? this.url)}.svg`;
  }
  /**
   ...
   */
  static getNameList() {
    return p(this.icons, (t, e) => e.replace(/^@/, ""));
  }
  /**
...
a(g, "icons", {}), a(g, "url", W("iconPath") ?? "/icons/");
var h = /* @__PURE__ */ ((s) => (s.file = "file", s.image = "image", s.color = "color", s.public = "public", s.filled = "filled", s.outlined = "outlined", s.round = "round", s.sharp = "sharp", s.twoTone = "two-tone", s.material = "material", s))(h || {});
class E extends j {
  /**
   * Constructor
  ...
  update() {
    ...
    if (t) {
      ...
      return i ? i[1] : g.is(t) ? h.public : h.material;
    }
  }
}
const F = 720;
  ...
  async initImage() {
    ...
    if (e)
      switch (this.type.get()) {
        ...
        case h.public:
          if (l(e))
            return g.get(e, (r = this.props) == null ? void 0 : r.url);
          break;
      }
  }
}
...
a(n, "objects", []), a(n, "objectsAdaptive", []), a(n, "cache", []), a(n, "event"), a(n, "time");
const D = "main", b = 256;
class P {
  /**
   * Constructor
  ...
  getWidth() {
    var t;
    return v(((t = this.props) == null ? void 0 : t.objectWidth) ?? 0);
  }
  /**
  ...
  getHeight() {
    var t;
    return v(((t = this.props) == null ? void 0 : t.objectHeight) ?? 0);
  }
  /**
   ...
   */
  reset() {
    this.is() && (n.is(this) ? n.reset() : n.add(this));
  }
  /**
  ...
  make() {
    ...
    if (this.beyond = !1, this.visible = !1, this.is())
      if ((t = this.props) != null && t.adaptiveAlways)
        ...
        i && (this.beyond = !(i.bottom < 0 - b || i.top > window.innerHeight + b), this.visible = !(i.bottom < 0 || i.top > window.innerHeight));
      }
    return this;
  }
  /**
...
let L = class extends w {
  ...
  constructor(e, i, r) {
    ...
    }), this.coordinator = new N(e), this.position = new O(e, this.coordinator), this.adaptiveItem = new P(
      e,
      this.data,
      i,
      () => this.make(!0)
...
class U {
  ...
  constructor(t, e) {
    a(this, "item");
    a(this, "type", d(() => this.item.getType()));
    a(this, "data", f());
    a(this, "text", d(() => this.item.getText()));
    a(this, "classes", d(() => this.item.getClasses()));
    a(this, "styles", f());
    this.item = new L(
      t,
      e,
    ...
    ), m(() => this.item.data.make(!0)), m(() => this.item.updateAdaptive());
  }
  /**
   * Destructor
   */
...
class et extends H {
  ...
  constructor(e, i, r) {
    ...
    this.image = new U(
      this.props,
      this.element
    ), this.init(), I(() => this.image.destructor()), S(
      this.image.data,
      (o) => {
        var c;

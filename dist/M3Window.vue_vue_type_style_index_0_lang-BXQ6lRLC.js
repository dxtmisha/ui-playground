...
var T = (o, t, s) => t in o ? $(o, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : o[t] = s;
var n = (o, t, s) => (T(o, typeof t != "symbol" ? t + "" : t, s), s);
import { shallowRef as m, watchEffect as x, onUnmounted as O, nextTick as H, h as v, Teleport as E, defineComponent as A, computed as b, openBlock as W, createBlock as R, unref as I } from "vue";
import { a as S, n as p } from "./string-BEtu6Ook.js";
import { D as F } from "./DesignConstructorAbstract-ySDET9gv.js";
import { d as D, b as B } from "./element-CA9epvId.js";
import { E as k } from "./EventItem-CzLiiCw2.js";
import { f as P } from "./frame-kG6wLD-J.js";
import { a as X, b as Y } from "./event-MN4DTwoE.js";
import { _ as N } from "./M3Scrollbar.vue_vue_type_style_index_0_lang-Bv0Au8ZA.js";
...
class Z {
   ...
   */
  // eslint-disable-next-line no-useless-constructor
  constructor(t, s, i, e, r, h, a, l, u, g, M) {
    n(this, "open", !1);
    n(this, "first", !1);
    this.props = t, this.status = s, this.client = i, this.hook = e, this.element = r, this.flash = h, this.coordinates = a, this.position = l, this.origin = u, this.callback = g, this.callbackEmit = M;
  }
  /**
...
class et {
  ...
  constructor(t, s, i, e, r = "is-window", h = "is-control", a = "is-body", l = "is-body-context") {
    ...
    n(this, "verification");
    n(this, "event");
    this.status = new _(), this.client = new q(), this.persistent = new L(t, i), this.hook = new U(t), this.classes = new G(
      this.persistent,
      r,
      h,
      a,
...
class it {
   ...
   */
  async update() {
    this.status.value = this.window.status.get(), this.staticMode.value = this.window.staticMode.is(), this.inDom.value = this.window.open.inDom(), this.open.value = this.window.open.get(), this.updateClasses(), await H();
  }
  /**

...
import { d as u, c as v } from "./data-DjQiFeY2.js";
import { t as l } from "./string-BNZv_PbS.js";
import { f as o, b as h, i as f } from "./element-RQY_EI-c.js";
class C {
  /**
   * Classes Constructor
  ...
  constructor(t, e = ["click"], i, r, m) {
     ...
     * @protected
     */
    s(this, "elementControl");
    s(this, "elementControlEdit");
    /**
     ...
     * @protected
     */
    s(this, "listenerRecent", (t) => {
      var e, i;
      f(this.elementControl) ? ((e = this.listener) == null || e.call(this.element, t, this.detail), u(this.options) && ((i = this.options) != null && i.once) && this.stop()) : this.stop();
    });
    /**
     * Event states.<br>
     * Состояния события.
     ...
     */
    s(this, "activity", !1);
    s(this, "activityItems", []);
    this.listener = i, this.options = r, this.detail = m, this.element = o(t), this.elementControl = h(t), this.type = l(e);
  }
  /**

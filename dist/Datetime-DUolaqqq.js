...
var k = (u, e, n) => e in u ? C(u, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : u[e] = n;
var h = (u, e, n) => (k(u, typeof e != "symbol" ? e + "" : e, n), n);
import { c as m, h as z } from "./data-DjQiFeY2.js";
import { c as A } from "./string-BNZv_PbS.js";
import { u as S } from "./useEnv-Cv-RoeJ-.js";
import { D as v } from "./DataStorage-DTeZWog5.js";
...
function g(u) {
  ...
  if (typeof u == "number")
    return new Date(u);
  let e = u, n = "";
  u.replace(/^([\s\S]+)([-+]\d{2}:?\d{2})$/, (o, t, r) => (e = t, n = r, o));
...
const L = [
  ...
  static getByCode(e) {
    let n;
    return e && (e.match(/([A-Z]{2}-[a-z]{2})|([a-z]{2}-[A-Z]{2})/) && (n = this.getByCodeFull(e)), !n && e.match(/[A-Z]{2}/) && (n = this.getByCountry(this.toCountry(e))), !n && e.match(/[a-z]{2}/) && (n = this.getByLanguage(this.toLanguage(e)))), this.toFull(A(n ?? this.getList()[0]));
  }
  /**
...
class B {
  ...
  relative(e, n, a) {
    ...
    let s = "second", i = (o.getTime() - t.getTime()) / 1e3;
    Math.abs(i) >= 60 && (s = "minute", i /= 60, Math.abs(i) >= 60 && (s = "hour", i /= 60, Math.abs(i) >= 24 && (s = "day", i /= 24, Math.abs(i) >= 30 && (s = "month", i /= 30, Math.abs(i) >= 12 && (s = "year", i /= 12)))));
    try {
      return new Intl.RelativeTimeFormat(this.getLocation(), r).format(Math.round(i), s);
    } catch {
    }
    return "";
  }
  ...
  relativeLimit(e, n, a, o, t, r, s) {
    const i = g(e), y = a || /* @__PURE__ */ new Date(), f = new Date(y), M = new Date(y);
    return f.setDate(y.getDate() - n), M.setDate(y.getDate() + n), i >= f && i <= M ? this.relative(
      i,
      o,
      y
    ) : this.date(

 ...
 */
export declare class ChipDesign<COMP extends ChipComponents, SETUP extends ChipSetup, EXPOSE extends ChipExpose, CLASSES extends ChipClasses, P extends ChipProps> extends ButtonDesign<COMP, SETUP, EXPOSE, CLASSES, P> {
}

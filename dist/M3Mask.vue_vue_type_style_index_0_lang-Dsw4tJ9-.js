...
import { m as Y, n as B, d as G, g as I, o as Z, s as L, c as b, k as v, f as U, b as F, p as J, q, u as Q, t as X, i as ee, v as te, a as E, D as ne, j as ae } from "./DesignConstructorAbstract-BkPabKy_.js";
import { u as se } from "./useEnv-DZ3hLZim.js";
import { D as ie } from "./DataStorage-sOo4HfVE.js";
import { t as A } from "./number-Bmx0fGP3.js";
import { C as f } from "./CacheItem-J86vAm6_.js";
import { u as w } from "./useInputCheck-DzllBgnq.js";
import { m as re } from "./event-BiJXLTc4.js";
const oe = [
  {
    country: "US",
    countryAlternative: [
  ...
  static getByCode(e) {
    let t;
    return e && (e.match(/([A-Z]{2}-[a-z]{2})|([a-z]{2}-[A-Z]{2})/) && (t = this.getByCodeFull(e)), !t && e.match(/[A-Z]{2}/) && (t = this.getByCountry(this.toCountry(e))), !t && e.match(/[a-z]{2}/) && (t = this.getByLanguage(this.toLanguage(e)))), this.toFull(Y(t ?? this.getList()[0]));
  }
  /**

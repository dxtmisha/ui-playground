...
var r = (s, t, e) => (y(s, typeof t != "symbol" ? t + "" : t, e), e);
import { computed as g, shallowRef as l, watchEffect as f, onUnmounted as k, watch as I, h as S } from "vue";
import { D as z } from "./DesignConstructorAbstract-ySDET9gv.js";
import { k as d, i as x, a as C } from "./string-BEtu6Ook.js";
import { D as v } from "./DesignAsyncAbstract-NAKp_GI2.js";
import { C as H } from "./CacheItem-J86vAm6_.js";
import { I as b } from "./Icons-BZks3rd4.js";
import { t as m } from "./number-Bmx0fGP3.js";
import { d as j } from "./element-CA9epvId.js";
import { E as W } from "./EventItem-CzLiiCw2.js";
...
class A extends H {
  ...
  update() {
    ...
    if (t) {
      ...
      return i ? i[1] : b.is(t) ? h.public : h.material;
    }
  }
}
const B = 720;
class E {
  ...
  static getSRC(t, e, i = B) {
    ...
    if ((e instanceof File || e === void 0) && (t.naturalHeight > i || t.naturalWidth > i)) {
      const o = t.naturalWidth >= t.naturalHeight, c = (a = document.createElement("canvas")) == null ? void 0 : a.getContext("2d");
  ...
  async initImage() {
    ...
    if (e)
      switch (this.type.get()) {
        ...
        case h.public:
          if (d(e))
            return b.get(e, (a = this.props) == null ? void 0 : a.url);
          break;
      }
  }
}
...
class n {
  ...
  static makePercent() {
    u.isSize() && this.objectsAdaptive.forEach((t) => {
      ...
      if (e) {
        const a = i.getWidth(), o = i.getHeight();
        t.setPercent(
          t.getWidth() * (a ? 1 / a : 0) * (i.getOffsetWidth() / e.offsetWidth),
...
r(n, "objects", []), r(n, "objectsAdaptive", []), r(n, "cache", []), r(n, "event"), r(n, "time");
const R = "main", p = 256;
class D {
  /**
   * Constructor
  ...
  constructor(t, e, i, a) {
    ...
    r(this, "beyond", !1);
    r(this, "visible", !1);
    this.props = t, this.data = e, this.element = i, this.callback = a, this.reset();
  }
  /**
  ...
  getGroup() {
    var t;
    return ((t = this.props) == null ? void 0 : t.adaptiveGroup) ?? R;
  }
  /**
...
let G = class extends v {
  ...
  constructor(e, i, a) {
    ...
    r(this, "adaptiveItem");
    r(this, "background");
    this.props = e, this.callback = a, this.type = new A(e), this.data = new F(e, this.type, () => {
      this.adaptiveItem.is() ? this.adaptiveItem.reset() : this.make(!0);
    }), this.coordinator = new M(e), this.position = new $(e, this.coordinator), this.adaptiveItem = new D(
      e,
      this.data,
      i,
      () => this.make(!0)
      ...
      switch (this.type.get()) {
        ...
        case "image":
          return {
            ...
            "background-position-y": (a = this.position) == null ? void 0 : a.getY()
          };
        case "public":
...
class N {
  ...
  constructor(t, e) {
    r(this, "item");
    r(this, "type", g(() => this.item.getType()));
    r(this, "data", l());
    r(this, "text", g(() => this.item.getText()));
    r(this, "classes", g(() => this.item.getClasses()));
    r(this, "styles", l());
    this.item = new G(
      t,
      e,

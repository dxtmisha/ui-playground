...
var D = (s, e, n) => e in s ? C(s, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : s[e] = n;
var h = (s, e, n) => (D(s, typeof e != "symbol" ? e + "" : e, n), n);
import { d as k, l as z, m as A } from "./object-Cv4Jn6-r.js";
import { t as y } from "./number-Bmx0fGP3.js";
import { u as m } from "./useEnv-BvhiIc68.js";
import { D as S } from "./DataStorage-B05-ygX6.js";
function p(s) {
  ...
  if (typeof s == "number")
    return new Date(s);
  let e = s, n = "";
  s.replace(/^([\s\S]+)([-+]\d{2}:?\d{2})$/, (o, t, r) => (e = t, n = r, o));
...
const E = [
  ...
  static findLocation() {
    var e;
    return this.storage.get() || ((e = document.querySelector("html")) == null ? void 0 : e.lang) || navigator.language || navigator.languages[0] || m("language") || "en-GB";
  }
  /**
...
h(l, "storage", new S(P)), h(l, "location"), h(l, "item"), h(l, "language"), l.location = l.findLocation(), l.language = l.findLanguage(l.location), l.item = l.getByCode(l.location);
let c = l;
class N {
  /**
   * Constructor
  ...
  number(e, n) {
    var a, o;
    return ((o = (a = this.numberObject(n)) == null ? void 0 : a.format) == null ? void 0 : o.call(a, y(e))) || e.toString();
  }
  /**
  ...
  currency(e, n, a = !1) {
    ...
    if (a) {
      ...
      return r ? r.formatToParts(y(e)).filter((u) => ["literal", "currency"].indexOf(u.type) === -1).join("") : e.toString();
    } else
   ...
   */
  date(e, n, a, o) {
    const t = p(e), r = typeof a == "string", u = this.dateOptions(n, r ? a : "short");
    return o && (u.hour12 = !1), r || Object.assign(u, a), t.toLocaleString(this.getLocation(), u);
  }
  /**
   ...
   */
  relative(e, n, a) {
    const o = p(e), t = a || /* @__PURE__ */ new Date(), r = {
      numeric: "auto",
      ...typeof n == "string" ? { style: n } : n || {}
    };
    let u = "second", i = (o.getTime() - t.getTime()) / 1e3;
    Math.abs(i) >= 60 && (u = "minute", i /= 60, Math.abs(i) >= 60 && (u = "hour", i /= 60, Math.abs(i) >= 24 && (u = "day", i /= 24, Math.abs(i) >= 30 && (u = "month", i /= 30, Math.abs(i) >= 12 && (u = "year", i /= 12)))));
    try {
      return new Intl.RelativeTimeFormat(this.getLocation(), r).format(Math.round(i), u);
    } catch {
    }
    return "";
  }
   ...
   * @param hour24 whether to use 12-hour time /<br>использовать ли 12-часовое время
   */
  relativeLimit(e, n, a, o, t, r, u) {
    const i = p(e), g = a || /* @__PURE__ */ new Date(), d = new Date(g), M = new Date(g);
    return d.setDate(g.getDate() - n), M.setDate(g.getDate() + n), i >= d && i <= M ? this.relative(
      i,
      o,
      g
    ) : this.date(
  ...
  month(e, n) {
    try {
      return Intl.DateTimeFormat(this.getLocation(), { month: n || "long" }).format(p(e));
    } catch {
    }
    return "";
  }
  ...
  weekday(e, n) {
    try {
      return Intl.DateTimeFormat(this.getLocation(), { weekday: n || "long" }).format(p(e));
    } catch {
    }
    return "";
  }
  ...
  weekdays(e) {
    ...
    try {
      ...
      for (let r = 0; r < 7; r++)
        n.push({
          label: o.format(a).replace(/^./, (u) => u.toUpperCase()),
          value: a.getDay()

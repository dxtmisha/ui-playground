...
import { f as I, H as j, J as C, h as x, g as v, i as y, d as P, k as M, q as _, u as Y, r as q, w as H, a as G, G as U, F as w, n as Q } from "./string-BEtu6Ook.js";
import { D as J } from "./DesignConstructorAbstract-ySDET9gv.js";
import { D as V, G as W } from "./Datetime-C3OarrO4.js";
import { C as f } from "./CacheItem-CG-KsNyj.js";
import { u as B } from "./useInputCheck-Uerc2Qj3.js";
import { m as z } from "./event-MN4DTwoE.js";
class X {
  /**
   * Constructor
...
class nt {
  ...
  getIntl() {
    var t;
    return new W((t = this.props) == null ? void 0 : t.language);
  }
  /**
...
class ht extends f {
  ...
  initValue() {
    ...
    return y(t) ? t : P(t) ? Object.keys(t) : [t];
  }
}
const L = /[0-9]/;
class ut {
...
class lt extends f {
  ...
  initList() {
    ...
    return this.type.isCurrencyOrNumber() ? Y(
...
class Ct {
  ...
  add(t, e, s = !0) {
    let i = !1;
    return this.selection.setByMask(t, s), this.rubberTransition.reset(), H(e).forEach((r) => {
   ...
   */
  reset(t = "") {
    if (this.character.reset(), this.rubber.reset(), G(t)) {
...
class It {
   ...
   */
  onBeforeinput(t) {
    this.emit.set("beforeinput", t).go(), this.unidentified || (this.makeChange(t), z(t));
  }
  /**
  ...
  setup(n, { expose: t, emit: e }) {
    const s = e, i = n, r = S(() => ({
      main: {
        ...
        [`m3-mask--dir--${i.dir}`]: Q(xt.dir, i.dir)
        // :classes-values [!] System label / Системная метка
      }
    })), h = S(() => ({

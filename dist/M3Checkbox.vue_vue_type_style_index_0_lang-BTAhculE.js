...
import { shallowRef as f, watchEffect as b, computed as m, h as c, defineComponent as M, openBlock as _, createBlock as S, unref as E } from "vue";
import { s as v, y as k, v as x, g as w, N as q } from "./DesignConstructorAbstract-SiNW5baF.js";
import { u as I } from "./useInputCheck-LJHawoYg.js";
import { u as O, a as F } from "./useEnabled-OgpLYIBQ.js";
import { p as g, _ as R } from "./M3FieldMessage.vue_vue_type_style_index_0_lang-CC8mJxro.js";
import { _ as j } from "./M3Image.vue_vue_type_style_index_0_lang-HSYJB8Ox.js";
import { _ as A } from "./M3Ripple.vue_vue_type_style_index_0_lang-CMRG0oRT.js";
import { p as D } from "./props-B-Ol7PG8.js";
class L {
  /**
   * Constructor
  ...
  getPattern() {
    ...
    return {
      ...
      min: (u = this.props) == null ? void 0 : u.min,
...
class H {
  ...
  getString() {
    var t;
    const e = this.get();
    return v(e) ? e.join(", ") : k(e) ? JSON.stringify(e) : e === !0 ? "1" : e === !1 ? "0" : x(e) ? ((t = e == null ? void 0 : e.toString) == null ? void 0 : t.call(e)) ?? "" : "";
  }
  /**
  ...
  getLength() {
    const e = this.get();
    return v(e) ? e.length : k(e) ? Object.keys(e).length : this.getString().length ?? 0;
  }
  /**
...
class J {
  ...
  constructor(e, t, s, n) {
    ...
    this.element = new N(
      e,
      t
    ), this.change = new P(), this.value = new H(
      e,
      this.element,
      this.change,
      s
...
class U extends q {
  ...
  constructor(t, s, n) {
     ...
     */
    r(this, "renderInputHidden", () => c("input", {
      name: this.props.name,
      type: "hidden",
      value: "0"
    }));

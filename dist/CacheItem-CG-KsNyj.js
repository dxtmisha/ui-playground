...
var l = (u, n, a) => n in u ? i(u, n, { enumerable: !0, configurable: !0, writable: !0, value: a }) : u[n] = a;
var r = (u, n, a) => (l(u, typeof n != "symbol" ? n + "" : n, a), a);
import { m as g, h } from "./string-BEtu6Ook.js";
import { u as p } from "./useEnv-YUBoiK5i.js";
import { D as y } from "./DataStorage-D0F_KbgZ.js";
const c = [
  {
    country: "US",
    countryAlternative: [
   ...
   */
  static set(n, a) {
    this.location = n, this.item = this.getByCode(this.location), this.language = this.findLanguage(this.location), a && this.storage.set(this.location);
  }
  /**
  ...
  static getByCode(n) {
    let a;
    return n && (n.match(/([A-Z]{2}-[a-z]{2})|([a-z]{2}-[A-Z]{2})/) && (a = this.getByCodeFull(n)), !a && n.match(/[A-Z]{2}/) && (a = this.getByCountry(this.toCountry(n))), !a && n.match(/[a-z]{2}/) && (a = this.getByLanguage(this.toLanguage(n)))), this.toFull(g(a ?? this.getList()[0]));
  }
  /**
  ...
  static getByCountry(n) {
    return this.getList().find((a) => {
      var o;
      return a.country === n || ((o = a == null ? void 0 : a.countryAlternative) == null ? void 0 : o.find((t) => t === n));
    });
  }
  /**
  ...
  static getByLanguage(n) {
    return this.getList().find((a) => {
      var o;
      return a.language === n || ((o = a == null ? void 0 : a.languageAlternative) == null ? void 0 : o.find((t) => t === n));
    });
  }
  /**
  ...
  static findLocation() {
    var n;
    return this.storage.get() || ((n = document.querySelector("html")) == null ? void 0 : n.lang) || navigator.language || navigator.languages[0] || p("language") || "en-GB";
  }
  /**
...
r(e, "storage", new y(f)), r(e, "location"), r(e, "item"), r(e, "language"), e.location = e.findLocation(), e.language = e.findLanguage(e.location), e.item = e.getByCode(e.location);
let s = e;
class k {
  /**
   * Constructor
   ...
   */
  getCache(n) {
    return this.isUpdate(n) && this.setCache(), this.cache;
  }
  /**
   ...
   * @param comparison additional data for comparison /<br>дополнительные данные для сравнения
   */
  async getCacheAsync(n) {
    return this.isUpdate(n) && await this.setCacheAsync(), this.cache;
  }
  /**
   ...
   */
  isUpdate(n) {
    return this.cache === void 0 || this.comparisons.length !== n.length || this.comparisons.findIndex((a, o) => a !== n[o]) >= 0 ? (this.comparisons = [...n], !0) : !1;
  }
}
export {
  k as C,
